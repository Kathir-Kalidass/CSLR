...
The motivation is also driven by usability expectations from end users. A system that is highly accurate in offline tests but unstable in live settings cannot serve assistive communication effectively. Hence, the present work prioritizes robustness, interpretability of outputs, and practical response time together, instead of treating these factors as secondary goals.
